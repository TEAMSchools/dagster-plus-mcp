...
server = MCPServer(
    ...
    instructions=(
        ...
        "For a failed run's raw stdout/stderr, call get_run_compute_logs with "
        "run_id — it resolves the run's compute-log key itself; add step_key "
        "when the run captured logs for several step workers. "
